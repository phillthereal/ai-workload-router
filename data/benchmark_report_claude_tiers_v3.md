...
Run group: `20260719T113230-91e5c641`

## Strategy comparison

| Strategy | Total cost (USD) | Mean quality | N |
|---|---|---|---|
| router | $0.018516 | 1.000 | 14 |
| frontier_only (baseline) | $0.019370 | 1.000 | 14 |

## Headline

- **Cost reduction vs baseline:** 4.4% (net of routing overhead)
...
|---|---|---|---|
| router | 2203.9 | 1833.6 | 14 |
| frontier_only (baseline) | 1949.2 | 1730.7 | 14 |

- **Router is 13.1% slower** than the frontier_only baseline on average (mean latency).

## At-scale cost projection

Cost per task in this run: router $0.001323, frontier_only (baseline) $0.001384. Projected monthly cost at scale, extrapolating linearly from that per-task rate:

| Volume (requests/month) | Baseline monthly $ | Router monthly $ | Savings/month $ |
|---|---|---|---|
| 100,000 | $138.36 | $132.26 | $6.10 |
| 1,000,000 | $1,383.57 | $1,322.57 | $61.00 |
...
| classification | router | $0.001564 | 1.000 | 4 |
| extraction | frontier_only | $0.003340 | 1.000 | 4 |
| extraction | router | $0.003132 | 1.000 | 4 |
| reasoning | frontier_only | $0.012745 | 1.000 | 5 |
| reasoning | router | $0.012745 | 1.000 | 5 |
...
| hard | router | $0.014730 | 1.000 | 9 |
| medium | frontier_only | $0.004640 | 1.000 | 5 |
| medium | router | $0.003786 | 1.000 | 5 |
